...
define('TITLE', 'my minb');
define('ROOT_DIR', 'content/');
define('META_DIR', '.minb/');
...
define('EMAIL', ''CHANGE_ME@' . $_SERVER['HTTP_HOST']');
...
$_bottom_content = 'Optimized for: <a href="http://getfirefox.com" target="_blank">Firefox</a> and <a href="http://www.google.com/chrome" target="_blank">Google Chrome</a>!&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;Powered by a custom CMS named "minb.0", the zero calories CMS!&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<small>HTML5 and CSS3 valid code as of the last check by W3C.</small>';
$_freelancer_content = '<h3>Links</h3>
<ul>
	<li>
		<a href="http://kabox.eu"><img src="http://kabox.visia.com/resources/74/KABOX-LOGO-S.png" title="KABOX, great friend and exceptional designer!" alt="design from KABOX!" style="width: 120px;" /></a>
	</li>
	<li><br /><a href="http://peta.org" target="_blank" title="PETA ...think about it!"><em>PeTA</em></a></li>
</ul>';
$_style = 'body {
